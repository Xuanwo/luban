...
- Outputs
  ...
  - Uploads packaged artifacts (and `latest.json`) to the corresponding GitHub release
  - GitHub release notes are generated by GitHub based on the changes since the previous release
