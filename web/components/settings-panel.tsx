...
import { ColorSchemeSettings } from "@/components/color-scheme"
...
function AllSettings({
  ...
  const { app, setAppearanceTheme, setAppearanceFonts, setLightColorScheme, setDarkColorScheme, setCustomColors, setTaskPromptTemplate, setSystemPromptTemplate } = useLuban()
  ...
  const lightCustomColors = app?.appearance?.color_scheme?.light_custom_colors
  const darkCustomColors = app?.appearance?.color_scheme?.dark_custom_colors
    ...
    <div className="space-y-12">
      <section id="theme" className="scroll-mt-8">
        ...
        <ColorSchemeSettings
          ...
          onCustomColorsChange={(schemeId, colors, mode) => {
            setCustomColors(mode, schemeId, colors)
          }}
        />
      </section>
    ...
    >
      <div className="w-60 flex-shrink-0 border-r border-border bg-sidebar flex flex-col">
        ...
        <div className="border-t border-border p-2">
          <div className="px-3 py-1.5 text-xs text-muted-foreground">Luban v0.1.5</div>
        </div>
      </div>
