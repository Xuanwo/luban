      ...
      <div className={cn("flex", enabled ? "h-[320px]" : "h-11")}>
        ...
        >
          <div className={cn("flex items-center justify-between h-11 px-3", enabled && "border-b border-border")}>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-primary" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <button
              ...
              className={cn(
                ...
                enabled ? "bg-primary" : "bg-muted-foreground/30 ring-1 ring-inset ring-border",
              )}
            ...
            >
              <div
                className={cn(
                  ...
                  enabled ? "bg-white translate-x-4" : "bg-muted-foreground/50 translate-x-0.5",
                )}
              />
            </button>
          </div>
    ...
    >
      <div className="w-60 flex-shrink-0 border-r border-border bg-sidebar flex flex-col">
        ...
        <div className="border-t border-border p-2">
          <div className="px-3 py-1.5 text-xs text-muted-foreground">Luban v0.1.6</div>
        </div>
      </div>
